    ...
    <div class="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                &nbsp;&nbsp;&nbsp;&nbsp;
                <!-- Navigation Links -->
                <div class="flex items-center max-w-sm p-3 mx-auto space-x-4 shadow-md sm:-my-px sm:ml-10 sm:flex bg-red rounded-xl">
                ...
                <div class="flex items-center max-w-sm p-3 mx-auto space-x-4 shadow-md sm:-my-px sm:ml-10 sm:flex bg-red rounded-xl">
                    ...
                    <x-jet-nav-link href="{{ route('doctypes.index') }}" :active="request()->routeIs('doctypes.*') || request()->routeIs('docapprovalguides.*')">
                        {{ __('Documents') }}
                    </x-jet-nav-link>
                </div>
                ...
                <div class="flex items-center max-w-sm p-3 mx-auto space-x-4 shadow-md sm:-my-px sm:ml-10 sm:flex bg-red rounded-xl">
                    ...
                    <x-jet-nav-link href="{{ route('documents.index') }}" :active="request()->routeIs('documents.*') || request()->routeIs('supportingdocuments.*')">
                        {{ __('Forms') }}
                    </x-jet-nav-link>
                </div>
